...
import { Ghost, MessageSquare, Trash, Plus, Loader2 } from "lucide-react";
  ...
  return (
    <main className="mx-auto max-w-7xl md:p-10">
      ...
      {files && files?.length !== 0 ? (
        <ul className="mt-8 grid-cols-1 gap-6 divide-y divide-zinc divide-zinc-200 md:grid-cols-2 lg:grid-cols-3">
          {files
            .sort(
              (a, b) =>
        ...
        <div className="mt-16 flex flex-col items-center gap-2">
          ...
          <h3 className="font-semibold text-xl">That is an empty field...</h3>
          <p>Should we upload your first PDF?</p>
        </div>
      )}
    </main>
  );
